...
class StripeController extends Controller
{
    public function StripeOrder(Request $request)
    {
        try {
            ...
            // Create charge with correct amount (multiply by 100 for cents, not 999)
