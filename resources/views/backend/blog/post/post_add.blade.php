                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row"> <!-- start 2nd row  -->
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>Post Title Urdu <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="post_title_urdu" class="form-control"
                                                            required="">
                                                        @error('post_title_urdu')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row"> <!-- start 8th row  -->
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea id="editor2" name="post_details_urdu" rows="10" cols="80">
						</textarea>
                                                    </div>
                                                </div>
