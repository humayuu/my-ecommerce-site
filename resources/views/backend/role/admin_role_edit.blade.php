        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form method="post" action="{{ route('update-admin-role') }}" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <fieldset>
                                                            <input type="checkbox" id="checkbox_10" name="return_order"
                                                                value="1"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <fieldset>
                                                            <input type="checkbox" id="checkbox_15" name="all_user"
                                                                value="1"
                                                                {{ $adminUser->all_user == 1 ? 'checked' : '' }}>
                                                            <label for="checkbox_15">Alluser</label>
                                                        </fieldset>

                                                        <fieldset>
                                                            <input type="checkbox" id="checkbox_16"
                                                                name="admin_user_role" value="1"
                                                                {{ $adminUser->admin_user_role == 1 ? 'checked' : '' }}>
