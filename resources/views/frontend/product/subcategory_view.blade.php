    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                <li><a href="#">Home</a></li>
                @foreach ($breadSubCategories as $breadSubCat)
                    <li class='active'>{{ $breadSubCat->category->category_name_en }}</li>
                @endforeach
                @foreach ($breadSubCategories as $breadSubCategory)
                    <li class='active'>{{ $breadSubCategory->subcategory_name_en }}</li>
                @endforeach
            </ul>
        </div>
        <!-- /.breadcrumb-inner -->
    ...
    <div class='container'>
        <div class='row'>
                    ...
                    <div id="myTabContent" class="tab-content category-list">
                        <div class="tab-pane active " id="grid-container">
                            <div class="category-product">
                                <div class="row" id="gured_view_product">

                                    @include('frontend.product.gured_view_product')
                                    <!-- /.item -->
                                </div>
                                <!-- /.row -->
                            </div>
            ...
            <div class="ajax-loadMore-product text-center" style="display:none;">
                <img src="{{ asset('frontend/assets/images/spinner.svg') }}" style="width:120px;height:120px;">
            </div>
        </div>
        <!-- /.row -->
        <!-- ============================================== BRANDS CAROUSEL ============================================== -->
...
<script>
    function loadMoreProduct(page) {
        $.ajax({
            ...
            .done(function(data) {
                if (data.guredView == "" || data.listView == "") {
                    $('.ajax-loadMore-product').hide();
                    return;
                }
                $('.ajax-loadMore-product').hide();
                $('#gured_view_product').append(data.guredView);
                $('#list_view_product').append(data.listView);
            })
            .fail(function() {
                $('.ajax-loadMore-product').hide();
